...
import { GoalsMetricsSection } from '@/components/projects/sections/goals-metrics-section';
...
async function SectionLoader({ projectId }: { projectId: number }) {
  ...
  if (!project) notFound();
  return <GoalsMetricsSection project={project as Parameters<typeof GoalsMetricsSection>[0]['project']} />;
}
...
export default async function GoalsMetricsPage({ params }: PageProps) {
