...
|-------|-------------------|
| `nextjs-best-practices.md` | UI components, pages, routing, data fetching |
| `langchain-patterns.md` | LangGraph workflows, LLM integrations, agents |
...
| Skill | When to Reference |
|-------|-------------------|
| `react-best-practices.md` | React performance, rendering optimization |
