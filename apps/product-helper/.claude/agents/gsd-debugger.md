...
- **IMPORTANT:** Use MCPSearch FIRST to load Context7 tools before invoking:
  ```
  ...
  ```
- See `.claude/get-shit-done/references/mcp-tools.md` for MCP usage patterns

**Local Skills (`.claude/skills/`):**
- `code-quality.md` — For debugging code structure issues
- `security-patterns.md` — For debugging auth/security issues
- `api-design.md` — For debugging API route issues
- `database-patterns.md` — For debugging database issues
