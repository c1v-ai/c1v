 ...
 *
 * EC-V21-E.11: each decision row carries a `<WhyThisValueButton />` next
 * to the Chosen value — opens the provenance side-panel (matched rule +
 * math trace + KB references + override history + override CTA).
 */
