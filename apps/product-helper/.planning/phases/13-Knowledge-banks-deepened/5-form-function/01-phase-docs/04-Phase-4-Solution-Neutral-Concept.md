...
phase_slug: phase-4-solution-neutral-concept
module: 5
artifact_key: module_5/phase-4-solution-neutral-concept
...
kb_chunk_refs: []
legacy_snapshot: apps/product-helper/.planning/phases/13-Knowledge-banks-deepened/_legacy_2026-04-26/5-form-function/01-phase-docs/04-Phase-4-Solution-Neutral-Concept.md
rewritten_at: 2026-04-27
rewritten_by: kb-rewrite (Wave-E γ-shape, EC-V21-E.9)
---
# phase-4-solution-neutral-concept
...
- **Decisions consumed by this phase:** see `decisions[]` in the engine.json keyed on `target_field` containing `phase-4-solution-neutral-concept` or by manual mapping in the story tree.
...
1. `searchKB` retrieves top-3 chunks scoped to `{module: 5, phase: phase-4-solution-neutral-concept}` (post-G8/G9 ingest).
...
- **Runtime retrieval:** `searchKB(query, top_k, { module: 5, phase: 'phase-4-solution-neutral-concept' })` over the `kb_chunks` table (`0011a_kb_chunks.sql`, ivfflat lists=100; HNSW upgrade gated on `>10k` rows).
