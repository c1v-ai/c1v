...
<task type="auto">
  <name>Task 1: Create overview sub-components</name>
  <files>
    components/project/overview/quick-instructions.tsx
    components/project/overview/project-context-card.tsx
    components/project/overview/artifact-pipeline.tsx
  ...
  <action>
    Create a `components/project/overview/` directory with 3 new components.
    ...
    **C. ArtifactPipeline (`artifact-pipeline.tsx`):**
  ...
  <verify>
    ...
    - All 3 files exist in `components/project/overview/`
  ...
  <done>
    ...
    - All components use CSS variable styling conventions
  </done>
</task>

<task type="auto">
  <name>Task 2: Compose redesigned overview page</name>
  <files>
    app/(dashboard)/projects/[id]/page.tsx
  </files>
  <action>
