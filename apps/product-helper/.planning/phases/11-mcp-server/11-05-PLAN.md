...
Implement our unique MCP tools that differentiate us from Epic.dev - PRD-SPEC validation, GSD workflow, CLEO tasks, agent invocation, and semantic search.
...
export const getValidationStatusTool: ToolHandler = {
  definition: {
    ...
    description: 'Get PRD-SPEC validation score and individual check results. Shows PRD completeness and quality.',
    inputSchema: {
      type: 'object',
      properties: {
        verbose: {
      ...
      properties: {
        agent: {
          ...
          enum: [
            ...
            'langchain-engineer', 'llm-workflow-engineer', 'prd-spec-validator',
...
- [ ] Validation status includes PRD-SPEC scores
- [ ] Tests pass
