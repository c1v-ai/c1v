...
import { GuidelinesSection } from '@/components/projects/sections/guidelines-section';
...
async function SectionLoader({ projectId }: { projectId: number }) {
  ...
  if (!project) notFound();
  return <GuidelinesSection project={project as Parameters<typeof GuidelinesSection>[0]['project']} />;
}
