...
import { NfrSection } from '@/components/projects/sections/nfr-section';
...
async function SectionLoader({ projectId }: { projectId: number }) {
  ...
  if (!project) notFound();
  return <NfrSection project={project as Parameters<typeof NfrSection>[0]['project']} />;
}
...
export default async function NfrPage({ params }: PageProps) {
