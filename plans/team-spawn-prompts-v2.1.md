...
TeamCreate({
  ...
  context: {
    ...
    canonical_paths_to_verify: {
      ...
      methodology: "Canonical home: system-design/kb-upgrade-v2/METHODOLOGY-CORRECTION.md (lock revoked 2026-04-26 — original 2026-04-25 lock at plans/kb-upgrade-v2/ was built on hallucinated disk facts; that file never existed there. Only on-disk copy is at system-design/kb-upgrade-v2/, co-located with the only complete 1-8 module tree). See plans/v21-outputs/ta1/methodology-canonical.md for full rationale.",
